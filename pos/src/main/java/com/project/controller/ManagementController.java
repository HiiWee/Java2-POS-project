...
public class ManagementController implements MouseListener {
    ...
    public void addActionCheck() {
        managementAddFrame.getCheckButton().addActionListener(new ActionListener() {
            @Override
    ...
    public void addActionUpdate(){
        managementEditFrame.getEditButtom().addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                update();
            }
